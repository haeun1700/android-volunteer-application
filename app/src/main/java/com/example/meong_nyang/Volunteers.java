...
public class Volunteers extends AppCompatActivity {
    ...
    public static ArrayList<VolunteerPost> arrayList;
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.info) {
                    intent = new Intent(Volunteers.this, MainActivity2.class);
                } else if (item.getItemId() == R.id.missing) {
                    intent = new Intent(Volunteers.this, LostAnimalBoardActivity.class);
                } else if (item.getItemId() == R.id.question) {
                    intent = new Intent(Volunteers.this, QnAActivity.class);
                } else if (item.getItemId() == R.id.apply) {
                    intent = new Intent(Volunteers.this, Volunteers.class);
                } else if (item.getItemId() == R.id.mypage) {
                    intent = new Intent(Volunteers.this, Mypage.class);
                }
